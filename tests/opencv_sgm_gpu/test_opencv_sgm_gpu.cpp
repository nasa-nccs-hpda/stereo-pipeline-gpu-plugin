...
public:
    ...
    void test_runCorrelator_basic_execution()
	{
        ...
        assert_test( \
			output.find("Running GPU StereoSGM with parameters:") != 				 			string::npos,
    ...
    void test_runCorrelator_parameter_parsing()
	{
		...
		cout << "Note, SGM fails if -num_disp differs from 128. "
			 << "Not all values have been attempted, though, and "
			 << "nothing regarding this has been found in its documentation."
			 << endl;
		...
		{
            const_cast<char*>("test_program"),
            const_cast<char*>("-num_disp"), const_cast<char*>("128"),
            const_cast<char*>("-mode"), const_cast<char*>("hh"),
            const_cast<char*>("-min_disp"), const_cast<char*>("8"),
            const_cast<char*>("-p1"), const_cast<char*>("28"),
            const_cast<char*>("-p2"), const_cast<char*>("12"),
            const_cast<char*>("-uniqueness"), const_cast<char*>("80"),
            const_cast<char*>(left_file.c_str()),
            const_cast<char*>(right_file.c_str()),
            const_cast<char*>(output_file.c_str())
        };
        ...
        assert_test(output.find("num_disp=128") != string::npos, 
					"Custom num_disp parameter parsed");
		
        assert_test(output.find("mode=HH") != string::npos, 
					"Custom mode parameter parsed");
        
		assert_test(output.find("min_disp=8") != string::npos, 
					"Custom min_disp parameter parsed");
        
		assert_test(output.find("p1=28") != string::npos, 
					"Custom p1 parameter parsed");
        
		assert_test(output.find("p2=12") != string::npos, 
					"Custom p2 parameter parsed");
        
		assert_test(output.find("uniqueness=80") != string::npos, 
					"Custom uniqueness parameter parsed");
    ...
    void test_runCorrelator_gdal_operations()
	{
        ...
        bool processing_started = \
			output.find("Running GPU StereoSGM") != string::npos;
    ...
    void test_runCorrelator_edge_cases()
	{
		...
		// Num_disp will abort unless equal to 128.
