...
public:
    ...
    void test_runCorrelator_basic_execution()
	{
        ...
        assert_test( \
			output.find("Running GPU StereoConstantSpaceBP " \
    ...
    void test_runCorrelator_parameter_parsing()
	{
        ...
        char* argv2[] = 
		{
            ...
            const_cast<char*>("-iters"), const_cast<char*>("19"),
            const_cast<char*>(left_file.c_str()),
            const_cast<char*>(right_file.c_str()),
            const_cast<char*>(output_file.c_str())
        };
        ...
        assert_test(output.find("iters=19") != string::npos, 
    ...
    void test_runCorrelator_gdal_operations()
	{
        ...
        bool processing_started = \
			output.find("Running GPU StereoConstantSpaceBP") != string::npos;
    ...
    void test_runCorrelator_stereo_processing()
	{
        ...
        char* argv[] = {
            ...
            const_cast<char*>("-iters"), const_cast<char*>("15"),
            const_cast<char*>(left_file.c_str()),
            const_cast<char*>(right_file.c_str()),
            const_cast<char*>(output_file.c_str())
        };
        ...
        assert_test(output.find("iters=15") != string::npos,
                    "runCorrelator sets iters");
