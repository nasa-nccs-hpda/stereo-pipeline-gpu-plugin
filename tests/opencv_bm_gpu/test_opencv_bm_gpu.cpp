...
public:
    ...
    void test_runCorrelator_basic_execution()
	{
        ...
        assert_test( \
			output.find("Running GPU StereoBM with parameters:") != 				 			string::npos,
    ...
    void test_runCorrelator_parameter_parsing()
	{
        ...
        char* argv2[] = 
		{
            ...
            const_cast<char*>("-block_size"), const_cast<char*>("19"),
            const_cast<char*>("-texture_thresh"), const_cast<char*>("8"),
            const_cast<char*>("-prefilter_cap"), const_cast<char*>("28"),
            const_cast<char*>("-uniqueness_ratio"), const_cast<char*>("12"),
            const_cast<char*>("-speckle_size"), const_cast<char*>("80"),
            const_cast<char*>("-speckle_range"), const_cast<char*>("24"),
            const_cast<char*>("-disp12_diff"), const_cast<char*>("3"),
            const_cast<char*>("-tile"), const_cast<char*>("256"),
            const_cast<char*>("-overlap"), const_cast<char*>("48"),
            const_cast<char*>(left_file.c_str()),
            const_cast<char*>(right_file.c_str()),
            const_cast<char*>(output_file.c_str())
        };
        ...
        assert_test(output.find("block_size=19") != string::npos, 
					"Custom block_size parameter parsed");
        
		assert_test(output.find("texture_thresh=8") != string::npos, 
					"Custom texture_thresh parameter parsed");
        
		assert_test(output.find("prefilter_cap=28") != string::npos, 
					"Custom prefilter_cap parameter parsed");
        
		assert_test(output.find("uniqueness_ratio=12") != string::npos, 
					"Custom uniqueness_ratio parameter parsed");
        
		assert_test(output.find("speckle_size=80") != string::npos, 
					"Custom speckle_size parameter parsed");
        
		assert_test(output.find("speckle_range=24") != string::npos, 
					"Custom speckle_range parameter parsed");
        
		assert_test(output.find("disp12_diff=3") != string::npos, 
					"Custom disp12_diff parameter parsed");
        
		assert_test(output.find("tile=256") != string::npos, 
					"Custom tile parameter parsed");
        
		assert_test(output.find("overlap=48") != string::npos, 
					"Custom overlap parameter parsed");
    ...
    void test_runCorrelator_gdal_operations()
	{
        ...
        // create_test_geotiff(left_file, 80, 80, 180.0f, 0.0f);
        // create_test_geotiff(right_file, 80, 80, 175.0f, 4.0f);
        ...
        bool processing_started = \
			output.find("Running GPU StereoBM") != string::npos;
    ...
    void test_runCorrelator_tiling_functionality()
	{
		...
		cout << "This case is a known error, and it will be addressed in " <<
				"the future." << endl;
		...
		{
            const_cast<char*>("test_program"),
            const_cast<char*>("-tile"), const_cast<char*>("64"),
            const_cast<char*>("-overlap"), const_cast<char*>("16"),
            const_cast<char*>(left_file.c_str()),
            const_cast<char*>(right_file.c_str()),
            const_cast<char*>(output_file.c_str())
        };
        ...
        assert_test(output.find("tile=64") != string::npos,
                    "runCorrelator sets custom tile size");

        assert_test(output.find("overlap=16") != string::npos,
                    "runCorrelator sets custom overlap");
    ...
    void test_runCorrelator_stereo_processing()
	{
        ...
        char* argv[] = {
            const_cast<char*>("test_program"),
            const_cast<char*>("-num_disp"), const_cast<char*>("32"),
            const_cast<char*>("-block_size"), const_cast<char*>("15"),
            const_cast<char*>(left_file.c_str()),
            const_cast<char*>(right_file.c_str()),
            const_cast<char*>(output_file.c_str())
        };
        ...
        assert_test(output.find("num_disp=32") != string::npos,
                    "runCorrelator sets stereo disparity range");
					
        assert_test(output.find("block_size=15") != string::npos,
                    "runCorrelator sets stereo block size");
